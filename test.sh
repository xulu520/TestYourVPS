...
speed() {
	...
	speed_test 'http://speedtest.seo01.softlayer.com/downloads/test100.zip' 'Softlayer, Seoul, KR'
...
speed_cli() {
	...
	printf "%-18s%-18s%-20s%-12s\n" "Node Name" "Upload Speed" "Download Speed" "Latency"
        speed_cli_test '' '默认节点 第一次'
	speed_cli_test '' '默认节点 第二次'
	speed_cli_test '' '默认节点 第三次'
...
backtracetest(){
	mtrback "180.163.68.13" "上海电信"
	mtrback "180.168.95.157" "上海电信国际精品网"
	mtrback "139.226.20.124" "上海联通"
	mtrback "183.192.160.3" "上海移动"
	mtrback "210.51.45.1" "上海网通（CUII）"
	mtrback "219.141.225.1" "北京电信"
	mtrback "125.33.55.33" "北京联通"
        mtrback "113.65.124.1" "广州电信"
	mtrback "36.36.97.16" "深圳天威"
	mtrback "183.60.137.161" "汕头电信"
	mtrback "14.29.70.1" "佛山电信"
